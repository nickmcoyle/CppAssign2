...
const char* const SceneXmlInvalid = STR(
...
TEST(loadInvalidXml, XmlReader)
{

    std::stringstream xmlStream(SceneXmlInvalid);

    Xml::HElement root = Xml::Reader::loadXml(xmlStream); //should throw
...
TEST(loadXmlComments, XmlReader)
{
